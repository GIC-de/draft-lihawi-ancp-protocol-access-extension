...
Discussion of this work occurs on the [Access Node Control Protocol
Working Group mailing list](mailto:ancp@ietf.org)
([archive](https://mailarchive.ietf.org/arch/browse/ancp),
[subscribe](ancp-request@ietf.org)).
...
[Working Group documents](https://datatracker.ietf.org/wg/ancp/documents/).
